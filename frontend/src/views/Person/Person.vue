        ...
        contextMenuModel.value =
            [
                ...
                {label: 'Карта денежного довольствия', icon: 'pi pi-fw pi-credit-card', command: () => {
                        ...
                        console.log(selectedPerson.value.money_certificate_id !== null)
                        if (selectedPerson.value.status === true || selectedPerson.value.status == null && selectedPerson.value.money_certificate_id !== null) {
