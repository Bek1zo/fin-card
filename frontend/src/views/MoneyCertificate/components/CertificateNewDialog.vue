...
<template>
    <Dialog :draggable="false" :pt="{
            ...
            v-model:visible="createMoneyCertificateDialog" :style="{ width: '800px' }" header="Создание новой карты денежного довольствия" @update:visible="emit('update:dialogStatus')" :modal="true" class="min-h-full p-fluid">
