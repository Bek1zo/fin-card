...
def get_money_certificate_file(id: str) -> str:
    ...
    with session_scope() as session:
        ...
        file_name = f'/tmp/{str(data.person_relation.lastname)}_{str(data.person_relation.firstname)}_{str(data.person_relation.middlename)}_{str(data.report_period_relation.value)}.xlsx'
